...
class EIP1559GasPriceEstimator {
  ...
  Future<EIP1559GasPrice?> get estimate async {
    try {
      ...
      final BigInt buffer = BigInt.from((tip / BigInt.from(100)) * _gasExtraPercentage);
      ...
      return EIP1559GasPrice(
        ...
        maxFeePerGas: block.baseFeePerGas != null
            ? (block.baseFeePerGas!.getValueInUnitBI(EtherUnit.wei) * BigInt.from(2)) + maxPriorityFeePerGas
